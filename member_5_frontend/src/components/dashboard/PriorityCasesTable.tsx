    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-xl">
      <div className="p-4 border-b border-slate-800 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400">Target cases requiring active correlation & network analysis</p>
        </div>
        <button
              ...
              >
                ...
                <td className="py-3.5 px-4">
                  <div className="flex items-center space-x-2">
                    <span className="font-mono font-bold text-rose-400 text-sm">{c.riskScore}/100</span>
                ...
                <td className="py-3.5 px-4 font-mono text-slate-300">
                  <div className="flex items-center space-x-1.5">
                    ...
                    <span className="text-[10px] text-slate-500">({c.forwardConnectionsCount}F / {c.backwardConnectionsCount}B)</span>
                  </div>
                </td>
                ...
                <td className="py-3.5 px-4 text-right">
                  <button
                    ...
                    className="px-3 py-1 bg-cyan-950/60 hover:bg-cyan-900/60 text-cyan-400 border border-cyan-500/40 rounded text-xs font-mono font-semibold transition-colors"
                  >
                    Open Case
                  </button>
                </td>
